...
export function studio(): Response {
  const page = studioPage()
    ...
    .replace("</textarea>", `</textarea><div class="creative-helper"><button class="secondary" id="improve-prompt" type="button">✦ Mejorar mi idea con IA</button><span>La IA estructura tu concepto para una composición artística e imprimible.</span></div><div class="prompt-presets" aria-label="Inspiración de dirección artística"><button type="button" data-inspiration="Cinematic original fantasy ensemble, hyper-realistic expressive faces, battle-ready poses, weathered armor, ruined city at golden dusk, dramatic depth and editorial lighting">⚔ Fantasía épica</button><button type="button" data-inspiration="Original spell-knight ensemble, elemental energy, weathered armor and leather, ancient ruins, 85mm cinematic film still, volumetric smoke and dust">✧ Anime: caballeros mágicos</button><button type="button" data-inspiration="Original adventure crew of three heroes, battle-ready group stance, expressive faces, worn fabric and steel, stormy harbor fortress, cinematic depth">☠ Anime: equipo aventurero</button><button type="button" data-inspiration="Original shadow hunters in a neon ruined city, realistic cursed blue energy, cinematic rain, volumetric fog, expressive faces, action-ready stance">◈ Anime: cazadores urbanos</button><button type="button" data-inspiration="Hyper-realistic urban hero, neon rain, layered streetwear, confident pose, cinematic cyan and fuchsia rim light, dynamic perspective">✦ Héroe urbano</button><button type="button" data-inspiration="Premium surreal animal mascot, energetic movement, vibrant ink textures, bold organic silhouette, print-ready visual hierarchy">◈ Mascota artística</button></div>`)
    .replace("</head>", `<style>
      body { font-size: 17px; }
